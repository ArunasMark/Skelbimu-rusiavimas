...
<body>
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-3">
                <div class="card-header">Skelbimu sąrašas</div>
                <div class="card-body">
                            ...
                            <tr>
                                <th><?php if ($d == "ASC") {
                                    ?> <a href="skelb.php?orderBy=id&d=DESC">Id numeris &uparrow;</a><?php
                                        ...
                                        href="skelb.php?orderBy=id&d=ASC">Id numeris &downarrow;</a><?php } ?></th>
                                <th><?php if ($d == "ASC") {
                                    ?> <a href="skelb.php?orderBy=text&d=DESC">Tekstas &uparrow;</a><?php
                                        ...
                                        href="skelb.php?orderBy=text&d=ASC">Tekstas &downarrow;</a><?php } ?></th>
                                <th><?php if ($d == "ASC") {
                                    ?> <a href="skelb.php?orderBy=cost&d=DESC">Kaina &uparrow;</a><?php
                                        ...
                                        href="skelb.php?orderBy=cost&d=ASC">Kaina &downarrow;</a><?php } ?></th>
                                <th><?php if ($d == "ASC") {
                                    ?> <a href="skelb.php?orderBy=onPay&d=DESC">Apmoketa &uparrow;</a><?php
                                        ...
                                        href="skelb.php?orderBy=onPay&d=ASC">Apmoketa &downarrow;</a><?php } ?></th>
                            </tr>
                        </thead>
                        <tbody>
